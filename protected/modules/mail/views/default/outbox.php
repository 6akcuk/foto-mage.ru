...
<div class="summary_wrap">
  ...
  <div class="summary">
    <?php echo Yii::t('user', 'Вы отправили {n} сообщение|Вы отправили {n} сообщения|Вы отправили {n} сообщений', $offsets) ?>
  </div>
</div>
<table id="messages" rel="pagination">
  ...
  <?php else: ?>
    <tr>
      <td><div class="empty">Здесь будут отображаться Ваши отправленные сообщения</div></td>
    </tr>
  <?php endif; ?>
</table>
