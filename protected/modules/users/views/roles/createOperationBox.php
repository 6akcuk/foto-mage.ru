...
$this->pageTitle = 'Добавить новую операцию';
?>
<div class="role_create_content">
  <?php $form = $this->beginWidget('ext.ActiveHtml.ActiveForm', array(
    'id' => 'addOperationForm'
  )); ?>
  <div id="op_create_result"></div>
  <div id="op_create_error" class="error"></div>
  ...
  <div id="op_create_warn" class="role_create_warn"></div>
  <?php $this->endWidget(); ?>
</div>
<?php
$this->pageJS = <<<HTML
