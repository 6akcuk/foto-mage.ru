...
if (Yii::app()->user->hasAccessEntry(RBACFilter::getHierarchy() .'City')) {
  $org->city_id = Yii::app()->user->model->profile->city_id;
}
...
$this->pageTitle = 'Добавить новую организацию';
?>
<div class="org_content">
  ...
  <div class="clear_fix">
    ...
    <div class="fl_l org_form_param">
      ...
      <div class="org_form_dropdown"><?php echo ActiveHtml::hiddenField('org_type_id', $org->org_type_id) ?></div>
    </div>
    <div class="fl_l org_form_param">
