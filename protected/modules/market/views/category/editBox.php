...
$this->pageTitle = 'Редактировать категорию товаров';
?>
  <div class="market_category_content">
    ...
    <div class="market_category_param"><?php echo ActiveHtml::hiddenField('parent_id', $category->parent_id, array('class' => 'text')) ?></div>
